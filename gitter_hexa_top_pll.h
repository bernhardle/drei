	...
	// $Source: /home/dfs/yc20/yc23/3/hier/developers/RCS/gitter_hexa_top_pll.h,v $
	// $Revision: 2.6 $
	// $Name:  $
	// $State: Exp $
	// $Date$
...
static volatile char RCSId_gitter_hexa_top_pll_h [] = "$Id: gitter_hexa_top_pll.h,v 2.6 1998/12/13 13:01:23 yc23 Exp yc23 $" ;
...
template < class A, class MX > inline Hbnd4PllExternal < A, MX > :: Hbnd4PllExternal (myhface4_t * f, int t) : Hbnd4Top < A > (0,f,t), _mxt (new MX (*this)) {
  restoreFollowFace () ;
  return ;
}
...
template < class A, class X, class MX > inline Hbnd4PllInternal < A, X, MX > :: HbndPll :: HbndPll (myhface4_t * f, int t) : A (f,t), _ext (*this) {
  return ;
}
...
template < class A, class X, class MX > Hbnd4PllInternal < A, X, MX > :: HbndPllMacro :: HbndPllMacro (myhface4_t * f, int t) : Hbnd4Top < micro_t > (0,f,t), _mxt (new MX (*this)) {
  restoreFollowFace () ;
  return ;
}
