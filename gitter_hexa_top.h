...
template < class A > class Hbnd4Top : public A {
  ...
  public :
    inline Hbnd4Top (int,myhface4_t *,int) ;
    virtual ~Hbnd4Top () ;
...
template < class A > inline Hbnd4Top < A > :: Hbnd4Top (int l, myhface4_t * f, int i)
...
template < class A > inline void Hbnd4Top < A > :: splitISO4 () {
  int l = 1 + level () ;
  assert (_dwn == 0) ;
  innerbndseg_t * b0 = new innerbndseg_t (l, subface4 (0,0), twist (0)) ;
  innerbndseg_t * b1 = new innerbndseg_t (l, subface4 (0,1), twist (0)) ;
  innerbndseg_t * b2 = new innerbndseg_t (l, subface4 (0,2), twist (0)) ;
  innerbndseg_t * b3 = new innerbndseg_t (l, subface4 (0,3), twist (0)) ;
  assert (b0 && b1 && b2 && b3) ;
  b0->append(b1) ;
  b1->append(b2) ;
  b2->append(b3) ;
...
template < class A > inline HexaTop < A > :: HexaTop (int l, myhface4_t * f0, int t0, myhface4_t * f1, int t1, 
  ...
  : A (f0, t0, f1, t1, f2, t2, f3, t3, f4, t4, f5, t5), _dwn (0), _bbb (0), _cv (0), _ed (0), _fc (0), _lvl (l),
