	...
	// $Source: /home/dfs/yc20/yc23/3/hier/optimized/RCS/mapp_tetra_3d.cc,v $
	// $Revision: 2.3 $
	// $Name:  $
	// $State: Exp $
...
static volatile char RCSId_mapp_tetra_3d_cc [] = "$Id: mapp_tetra_3d.cc,v 2.3 1998/12/01 09:13:49 yc23 Exp yc23 $" ;

const double quadraturTetra3Dbasis :: _p1 [4] =  {0.125, 0.125, 0.125, 0.125} ;
