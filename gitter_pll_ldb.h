	...
	// $Source: /home/dfs/yc20/yc23/3/hier/developers/RCS/gitter_pll_ldb.h,v $
	// $Revision: 2.2 $
	// $Name:  $
	// $State: Exp $
...
static volatile char RCSId_gitter_pll_ldb_h [] = "$Id: gitter_pll_ldb.h,v 2.2 1998/10/29 11:39:18 yc23 Exp yc23 $" ;
...
class LoadBalancer {
  ...
  public :
	...
	void graphCollect (const MpAccessGlobal &,insert_iterator < ldb_vertex_map_t >,
		insert_iterator < ldb_edge_set_t >) const throw (OutOfMemoryException, InvalidGraphException) ;
      public :
        enum method { 
	              NONE = 0,
		      COLLECT = 1,
